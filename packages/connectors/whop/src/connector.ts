...
import { WhopClient, createWhopClient } from './client.js';

export class WhopConnector implements CommerceConnector {
  readonly platform = 'whop';
  private client: WhopClient | null = null;
   ...
   */
  private async mapActionToAPI(action: Action): Promise<any> {
    if (!this.client) {
