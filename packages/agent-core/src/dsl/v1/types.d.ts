 ...
 */
export type Action = CreateCustomerAction | GetCustomerAction | UpdateCustomerAction | ListPaymentsAction | GetPaymentAction | ListSubscriptionsAction | GetSubscriptionAction | CancelSubscriptionAction | CheckAccessAction | GrantAccessAction | RevokeAccessAction | SendNotificationAction;
/**
 ...
 */
export declare const WHITELISTED_ACTION_TYPES: readonly ["create_customer", "get_customer", "update_customer", "list_payments", "get_payment", "list_subscriptions", "get_subscription", "cancel_subscription", "check_access", "grant_access", "revoke_access", "send_notification"];
