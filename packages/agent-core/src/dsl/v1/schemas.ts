 ...
 */
export function validateAction(action: unknown): { success: true; data: z.infer<typeof ActionSchema> } | { success: false; error: z.ZodError } {
...
export function validatePlan(plan: unknown): { success: true; data: z.infer<typeof PlanSchema> } | { success: false; error: z.ZodError } {
